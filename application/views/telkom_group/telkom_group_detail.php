...
<?php
  if($status){
      $name='';
      $kode='';
    if($this->input->post('idData')==24){
      $name='TELKOM';
    }else if($this->input->post('idData')==25){
      $name='SPEEDY';
      $kode= '';
    }else if($this->input->post('idData')==26){
      $name='TELKOMVISION';
    }
...
?>
              <div class="col-md-12"><br>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <input type="text2" class="form-control plss" value="<?php echo $item[11].' Rp. '.format_angka($item[12]); ?>" disabled>
...
?>
  ...
  <script type="text/javascript">
   ...
   $('#bayar').on('click', function(){
      ...
      var istatus2 = 'bayar';
    if(iidData){
        loadContentWithParams('telkom_group.telkom_group_detail2', { 
          inv : inv, 
          idData : iidData, 
          msg : imsg, 
          harga : iharga, 
