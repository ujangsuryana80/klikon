...
?>
  ...
  <!-- Start Presentation -->
    <div class="row presentation"> 
      <h1>PEMBAYARAN TELKOM TELAH SUKSES</h1>
...
<?php
  ...
  <script type="text/javascript">
   $('#advice').on('click', function(){
    ...
    if(nav){
        loadContentWithParams('telkom_group.advice-telkom-group2', { 
          idData : nav, 
          msg : msg3, 
          harga : harga,         
          inv : inv,         
   ...
   $('.cetakstruk').on('click', function(){
    ...
    var wdt = $(window).width();   
      window.open("<?php echo base_url(); ?>telkom_group/cetakTelkom?"+nav+"&width_paper="+wdt,"CETAK","width=800,height=600,location=no,menubar=no,toolbar=no,scrollbars=yes,resizeble=yes");
   });
