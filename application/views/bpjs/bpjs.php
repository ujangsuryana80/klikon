...
?>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-title">
         <img src="<?php echo base_url(); ?>assets/img/bpjs.png" width="20px" height="20px" alt="Klikonlineplus.com"> BPJS Kesehatan
        </div>
...
<?php
  if($status){    
    $message  =  "BPJSKS.".$nomor_tujuan.".EDC.192#*168#*3#*231.160927710784.f792ce0176fc3eaad8d59210d0b47942";
...
?>
  ...
  <script type="text/javascript">
   $('#cek').on('click', function(){     
      ...
      loadContentWithParams('bpjs.bpjs', { 
          msg : imsg,
          status : istatus
           });
  });
   ...
   $('#bayar').on('click', function(){
      ...
      var istatus2 = 'bayar';
    if(iidData){
        loadContentWithParams('bpjs.bpjs_detail', { 
          inv : inv, 
          msg : imsg, 
          harga : iharga, 
          status2 : istatus2
