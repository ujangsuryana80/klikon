...
?>
  ...
  <!-- Start Presentation -->
    <div class="row presentation"> 
      <h1>PEMBAYARAN BPJS TELAH SUKSES</h1>
...
<?php
  ...
  <script type="text/javascript">
   $('#advice').on('click', function(){
    ...
    if(nav){
        loadContentWithParams('bpjs.advice-bpjs3', { 
          idData : nav, 
          msg : msg3, 
          harga : harga,
          inv : inv,         
  ...
  $('.cetakstruk').on('click', function(){
    ...
    var wdt = $(window).width();   
      window.open("<?php echo base_url(); ?>bpjs/cetakstruk?"+nav+"&width_paper="+wdt,"CETAK","width=800,height=600,location=no,menubar=no,toolbar=no,scrollbars=yes,resizeble=yes");
   });
