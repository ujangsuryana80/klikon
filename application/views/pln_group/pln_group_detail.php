            ...
            <div class="panel-body">
                <div class="row">  
                  <div class="col-md-12"><br>
                      ...
                      <?php if($items[0]['idData']==22){ ?>
                      <br>
                      <select id="harga" class="form_biru2" size="1">
                        ...
                        <option value="5000000">50.000000</option>
                      </select>
                      <?php }?>
                  </div>
                </div><br>                
...
<?php
  if($status){
      $name='';
      $kode='';
    if($this->input->post('idData')==21){
      $name='PLN';
    }else if($this->input->post('idData')==22){
      $name='PLNPREPAID';
      $kode= ".".$harga.";0";
    }else if($this->input->post('idData')==23){
      $name='PLNNONTAGLIST';
    }
    $message  =  $name.".".$nomor_tujuan.$kode.".EDC.192#*168#*3#*231.160927710784.f792ce0176fc3eaad8d59210d0b47942";
    //echo($message);
              ...
              <div class="col-md-12"><br>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text2" class="form-control plss" value="<?php echo $item[7].' '.format_angka($item[8]); ?>" disabled>
                    <input type="text" class="form-control plss" value="<?php echo $item[9].' '.format_angka($item[10]); ?>" disabled>
                  </div>

                  <div class="col-md-6">
                    <input type="text2" class="form-control plss" value="<?php echo $item[11].' '.format_angka($item[12]); ?>" disabled>
...
?>
  ...
  <script type="text/javascript">
   ...
   $('#bayar').on('click', function(){
      ...
      var istatus2 = 'bayar';
    if(iidData){
        loadContentWithParams('pln_group.pln_group_detail2', { 
          inv : inv, 
          idData : iidData, 
          msg : imsg, 
          harga : iharga, 
