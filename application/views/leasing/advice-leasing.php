...
?>
  ...
  <!-- Start Presentation -->
    <div class="row presentation"> 
      ...
      <button type="button" id="<?php echo($cetak);?>" class="cetakstruk"  data-item="<?php echo http_build_query($item); ?>"><i class="fa fa-print" style="font-size:24px;"></i> Cetak Struk</button>          
    </div>
  </div>
...
<?php
  ...
  <script type="text/javascript">
   $('#advice').on('click', function(){
    ...
    if(nav){
        loadContentWithParams('leasing.advice-leasing2', { 
          idData : nav, 
          msg : msg3, 
          harga : harga,         
          inv : inv,         
