...
<?php
  ...
  <!-- Start Presentation -->
    <div class="row presentation"> 
      <h1>PEMBAYARAN TV BERLANGGANAN TELAH SUKSES</h1>
 ...
 <!-- Start Presentation -->
  ...
  <script type="text/javascript">
   $('#advice').on('click', function(){
    ...
    if(nav){
        loadContentWithParams('tv_berlangganan.advice-tv-berlangganan4', { 
          idData : nav, 
          msg : msg3, 
          harga : harga,
          inv : inv,         
  ...
  $('.cetakstruk').on('click', function(){
    ...
    var wdt = $(window).width();   
      window.open("<?php echo base_url(); ?>tv_berlangganan/cetakTvBerlangganan?"+nav+"&width_paper="+wdt,"CETAK","width=800,height=600,location=no,menubar=no,toolbar=no,scrollbars=yes,resizeble=yes");
   });
