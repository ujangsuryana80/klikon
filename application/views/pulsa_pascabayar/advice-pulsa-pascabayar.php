...
<?php
    ...
    //$message  =  "REVERADVICE.".$inv.".EDC.IP.PIN.SESSEC";
    //echo($message3);
...
?>
  ...
  <!-- Start Presentation -->
    <div class="row presentation"> 
      <h1>PEMBAYARAN PULSA PASCABAYAR TELAH SUKSES</h1>
...
<?php
  ...
  <script type="text/javascript">
   $('#advice').on('click', function(){
    ...
    if(nav){
        loadContentWithParams('pulsa_pascabayar.advice-pulsa-pascabayar2', { 
          idData : nav, 
          msg : msg3, 
          harga : harga,         
          inv : inv,         
   ...
   $('.cetakstruk').on('click', function(){
    ...
    var wdt = $(window).width();
      window.open("<?php echo base_url(); ?>pulsa_pascabayar/cetakPlsPascabayar?"+nav+"&width_paper="+wdt,"CETAK","width=800,height=600,location=no,menubar=no,toolbar=no,scrollbars=yes,resizeble=yes");
   });
